---
layout:     post
title:      "【转载】（WIP）深入理解 Sketch 库（中）"
subtitle:   ""
#date:       2018-06-01 16:25:00
author:     "Caiyunsky"
header-mask: 0.3
...
![img](https://ashung.github.io/images/deep-into-sketch-library/automate_arrange_menu.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/color_symbol.png)

在使用这种色版组件时，可以直接拉大至覆盖整个内容，巧妙的使用这种组合，可以让同一个组件快速调整内容和颜色。

![img](https://ashung.github.io/images/deep-into-sketch-library/color_symbol_for_icons.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/automate_style_menu.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/automate_fix_library_id_conflic.png)
...
![img](https://raw.githubusercontent.com/sonburn/symbol-swapper/master/Screenshots/Library%20Swapper.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/automate_imported_symbols_link_manage.png)
...
转载地址：[https://ashung.github.io/posts/deep-into-sketch-library-part2.html](https://ashung.github.io/posts/deep-into-sketch-library-part2.html)
