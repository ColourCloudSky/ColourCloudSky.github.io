---
layout:     post
title:      "【转载】深入理解 Sketch 库（上）"
subtitle:   ""
#date:       2018-06-01 15:50:00
author:     "Caiyunsky"
header-mask: 0.3
...
![img](https://ashung.github.io/images/deep-into-sketch-library/welcome_templates.png)

库则是指被添加到 “Preferences - Libraries” 面板下的那些文件，它们没有统一保存的地方。

![img](https://ashung.github.io/images/deep-into-sketch-library/libraries_preferences.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/edit_internal_library_symbol.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/edit_user_library_symbol.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/symbols_categories.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/replace_symbol_with_library_symbol.png)
...
![img](https://ashung.github.io/images/deep-into-sketch-library/mac_connect_to_servers_1.png)

要解决每次开机手动链接服务器的问题，可以设置开机自动链接。这个设置需要在链接服务器时，勾选 “在我的钥匙串记住此密码”。

![img](https://ashung.github.io/images/deep-into-sketch-library/mac_connect_to_servers_2.png)

然后在 “系统便好设置” - “用户与群组” ，选择当前用户的 “登录项”，并将相应的网络硬盘加入列表中并保持选中。

![img](https://ashung.github.io/images/deep-into-sketch-library/mac_automonut.png)
...
转载地址：https://ashung.github.io/posts/deep-into-sketch-library-part1.html

作者：[Ashung](https://github.com/Ashung)
